                    ...
                    <div class="flex items-center">
                        <ul id="list"
                            ...
                            <li
                                ...
                                <a href="/pets">
                                    <span class="ml-2 font-bold">Fur Babies</span>
                                </a>
                            </li>
                            ...
                            @auth
                                <li class="flex flex-col cursor-pointer text-gray-600 dark:text-gray-200 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center"
                                    onclick="dropdownHandler(this)">
                                    <a href="/pets/manage">
                                        <span class="ml-2 font-bold">My Pets</span>
                                    </a>
                                </li>
                            @endauth
                        </ul>
                ...
                <div class="w-5/6">
                    <div class="flex items-center justify-end">
                        <ul class="text-gray-800 dark:text-white lg:space-x-8 flex items-center leading-none">
                            <li>
                                <a class="hover:text-indigo-500 text-lg focus:text-indigo-500 text-gray-500"
                                    href="/pets">Fur Babies</a>
                            </li>
                            <li class="ml-4 hover:text-indigo-500 ">
                                <a class="focus:text-indigo-500 text-lg text-gray-500 hover:text-indigo-700"
                                    href="/about">Our
                                    Advocacy</a>
                            </li>
                        ...
                        @auth
                            ...
                            <div class="pl-2">
                                ...
                                <button class="border-2 border-indigo-500 text-indigo-500 bg-transparent py-2 px-4 rounded">
                                    <a href="/pets/add"><i class="fa-solid fa-plus"></i>&nbsp;Add New</a>
                                </button>
