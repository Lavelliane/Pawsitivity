<x-layout>
    <div class="pt-32 lg:flex items-center relative z-10 container mx-auto">
        <div class="w-full lg:w-1/2 h-full lg:pr-10 xl:pr-0">
            <img tabindex="0" role="img" aria-label="dogoo" class="mx-auto"
                 alt="doggo" src="{{asset('assets/PAW.png')}}"/>
        </div>
        <div role="contentinfo" class="w-full lg:w-2/5 h-full lg:ml-4">
            ...
            <h1 tabindex="0" class="text-indigo-700 text-xl lg:text-6xl font-black mb-8">Love starts with
                adoption</h1>
            <p tabindex="0" class="text-gray-800 font-regular mb-8 ">Welcome to our pet adoption platform! We
                ...
                <div class="">
                    <button role="button" aria-label="live chat"
                        class="focus:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 hover:bg-indigo-600 text-white px-6 py-2 font-semibold rounded focus:outline-none">Adopt
                        a Pet</button>
                </div>
        </div>
