<x-layout>
    <div class="pb-10">
        <img src="https://i.ibb.co/DQ4FZhL/pattern-bg.png" alt="blue pattern background"
            ...
            <div class="lg:w-1/2 md:w-8/12 sm:w-9/12 w-full">
                ...
                <div class="bg-white shadow rounded p-8 mt-8">
                    ...
                    <ul class="hidden">
                        <li>
                            <p class="text-base leading-normal text-gray-600 mt-4 lg:w-96">
                                You can contact our customer support team by sending an email to pawsitivity@gmail.com. Our team will respond to your
